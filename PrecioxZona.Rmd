...
En el dataset de listings solo se tienen las siguientes variables descriptivas de la vivienda: nº de habitaciones, nº de baños, nº deacommodates y una lista de servicios, por lo que se va a realizar una regresión lineal para comprobar cuanto afecta cada variable respectivamente al precio (dollarPrice).
