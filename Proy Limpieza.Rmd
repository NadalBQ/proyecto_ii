...
library(FactoMineR)
library(factoextra)
res.pca = PCA(list_limpiado_pisos2, scale.unit = TRUE, graph = FALSE, ncp = 4, quanti.sup = , quali.sup = which(descValList$tipo %in% c('text', 'binary')))
...
```{r guardar}
write.csv(list_limpiado_pisos_sin_anom, "valencia_listings_limpio.csv")
```
